...
%    meridianos celestes (Â¡lo que me costÃ³!)
...
%    \tdplotsetrotatedcoords{20}{-\colatitud-20}{0}
    ...
    spherical cs:radius=1*\r,latitude=0,longitude=90) circle (2pt)
    node[above=3pt] {\LARGE \bfseries Culminación superior (12h)};
    ...
    % \draw[decoration={text along path,
    %   text={|\sffamily\footnotesize\color{yellow!85!white}|Eclíptica},
 ...
 %   mov sol
    ...
    % \draw[yellow,>=Latex, ultra thick, tdplot_rotated_coords, ->]
    % plot[variable=\t,domain=140:10] (xyz spherical
    % cs:radius=1*\r,latitude=0,longitude=\t);
